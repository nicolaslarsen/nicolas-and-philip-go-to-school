...
evalSimple (Pow exp1 exp2) = let x = evalSimple exp1 in if x == 42
                              then x ^ evalSimple exp2
                              else x ^ evalSimple exp2
                              -- just to force eager evaluation
...
evalFull (Pow exp1 exp2) env = let x = evalFull exp1 env in
                                   if x == 42 -- We really just need to evalue x
                                      then x ^ exponent
                                      else x ^ exponent
